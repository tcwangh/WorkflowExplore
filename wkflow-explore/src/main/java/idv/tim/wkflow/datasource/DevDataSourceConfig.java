...
@Configuration
@Profile("development")
@EnableJpaRepositories(basePackages="idv.tim.wkflow.persistence", entityManagerFactoryRef = "getEntityManagerFactoryBean")
public class DevDataSourceConfig implements DataSourceConfig{
	  ...
	  public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() throws IllegalArgumentException, NamingException {
	      ...
	      em.setPackagesToScan("idv.tim.wkflow.model");
